...
%Desired unitary
% load evol24567.mat
% params.Uwant = U_evol24567;
% load C190.mat
% params.Uwant = U_C190;
Ix = [0,1;1,0]; I = [1,0;0,1];
params.Uwant = expm(-i*pi/4*kron(Ix,kron(I,I)));
...
params.RFmatts(:,:,1) = (1/2)*full(mkstate('+1XII+1IXI+1IIX',0));
params.RFmatts(:,:,2) = (1/2)*full(mkstate('+1YII+1IYI+1IIY',0));
...
params.pulsefreq = [-10000 -10000 -10000];	
