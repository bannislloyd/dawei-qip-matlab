...
addpath H:\Matlab\Twqubit_Circuit_PPS\simulation\Encoding1_Operators

%% for 7 qubits: Ob C2 %%%%%%%%
% load exp_encoding1_obC2_Hdecouple.mat
% 
...
% 
%     % plot setting
%    set(gca,'Xdir','reverse','Xlim', [min(X+90) max(X-90)],'Ylim',[-0.05 0.05]);
%     fontsize = 14;
%     fontsize_legend = 12;
%     
%     title_string = ['Encoding1 IZIZZZZIIIII: Ob C2 with H decoupled'];
...
% 
%  figure_name=strcat('encoding1_C2_Hdecouple-',date);
%  saveas(gca, figure_name, 'fig');
% 
% %% for 7 qubits: Ob C7 %%%%%%%%
% load exp_encoding1_obC7_Hdecouple.mat
% 
% load Para_7qubit.mat
...
%     fontsize_legend = 12;
%     
%     title_string = ['Encoding1 IZIZZZZIIIII: Ob C7 with H decoupled'];
%     title({title_string},'FontWeight','normal','FontSize',fontsize,...
%    'FontName','Calibri',...
%    'FontAngle','normal');
% 
...
%     'FontWeight','normal','FontSize',fontsize_legend);
% 
%  figure_name=strcat('encoding1_C7_Hdecouple-',date);
%  saveas(gca, figure_name, 'fig');
 
%% for 12 qubits: Ob C2 %%%%%%%%
load exp_encoding1_obC2.mat
...
plot(X_exp,Y_exp/scale_factor)
    ...
    title_string = ['Encoding1 IZIZZZZIIIII: Ob C2'];
    title({title_string},'FontWeight','normal','FontSize',fontsize,...
   'FontName','Calibri',...
   'FontAngle','normal');
 ...
 figure_name=strcat('encoding1_C2-',date);
 saveas(gca, figure_name, 'fig');

%% for 12 qubits: Ob C7 %%%%%%%%
load exp_encoding1_obC7.mat
...
plot(X_exp,Y_exp/scale_factor)
    ...
    title_string = ['Encoding1 IZIZZZZIIIII: Ob C7'];
    title({title_string},'FontWeight','normal','FontSize',fontsize,...
   'FontName','Calibri',...
   'FontAngle','normal');
 ...
 figure_name=strcat('encoding1_C7-',date);
 saveas(gca, figure_name, 'fig');
