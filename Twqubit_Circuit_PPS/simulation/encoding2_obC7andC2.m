...
% tic
% rho= R(gop(7,Z),90)*U*R(gop(7,Z),90)'*rho_encoding2_grape*(R(gop(7,Z),90)*U*R(gop(7,Z),90)')';
...
tic
rho= R(gop(2,Z),90)*U*R(gop(2,Z),90)'*rho_encoding2_grape*(R(gop(2,Z),90)*U*R(gop(2,Z),90)')';
toc
