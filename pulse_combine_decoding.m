...
step_CH = round(1/(4*148.5)/dt);

step_23 = round((1/(8*Para(2,3)))/dt);
step_12_23 = round((1/(4*Para(1,2))-1/(8*Para(2,3)))/dt);
step_23_12 = round((1/(4*Para(2,3))-1/(4*Para(1,2)))/dt);

step_27 = round((1/(8*Para(2,7)))/dt);

step_57 = round((1/(4*Para(5,7)))/dt);
% all free evolutions
FreeCH = zeros(step_CH,1); Free23 = zeros(step23,1); Free12_23 = zeros(step_12_23,1); Free23_12 = zeros(step_23_12,1); Free27 = zeros(step_27,1); Free57 = zeros(step_57,1);
...
P2C = power_134690andH90_C; PH2C = phase_134690andH90_C; P2H = power_134690andH90_H; PH2H = phase_134690andH90_H;
...
P8C = power_C7180_C; PH8C = phase_C7180_C; P8H = power_C7180_H; PH8H = phase_C7180_H;
P9C = power_C1180_C; PH9C = phase_C1180_C; P9H = power_C1180_H; PH9H = phase_C1180_H;
P10C = power_C5180_C; PH10C = phase_C5180_C; P10H = power_C5180_H; PH10H = phase_C5180_H;
...
power_decoding_C = [FreeCH; P1C; FreeCH;P2C; ...
                                           Free23; P8C; Free12_23; P9C; Free23_12; P11C; Free23; P8C; Free23; P3C; ...
                                           Free27; P10C; Free27; P4C; Free27; P10C; Free27; P5C; ...
                                           Free57; P6C; Free57; P7C]*Calibration/Calibration_old;
phase_decoding_C = [FreeCH; PH1C; FreeCH;PH2C; ...
                                           Free23; PH8C; Free12_23; PH9C; Free23_12; PH11C; Free23; PH8C; Free23; PH3C; ...
                                           Free27; PH10C; Free27; PH4C; Free27; PH10C; Free27; PH5C; ...
                                           Free57; PH6C; Free57; PH7C];    
                                      
power_decoding_H = [FreeCH; P1H; FreeCH;P2H; ...
                                           Free23; P8H; Free12_23; P9H; Free23_12; P11H; Free23; P8H; Free23; P3H; ...
                                           Free27; P10H; Free27; P4H; Free27; P10H; Free27; P5H; ...
                                           Free57; P6H; Free57; P7H]*Calibration/Calibration_old;        
                                       
phase_decoding_H = [FreeCH; PH1H; FreeCH;PH2H; ...
                                           Free23; PH8H; Free12_23; PH9H; Free23_12; PH11H; Free23; PH8H; Free23; PH3H; ...
                                           Free27; PH10H; Free27; PH4H; Free27; PH10H; Free27; PH5H; ...
