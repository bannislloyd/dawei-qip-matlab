...
%% Final
Mean_Dec(1) = 0.7645; Mean_Fin(1) = Mean_Dec(1)/Mean_Cali(1); %0.9404;
Std_Dec(1) = 0.0120; Std_Fin(1) = 0.0148;

Mean_Dec(2) = 0.6416; Mean_Fin(2) = Mean_Dec(2)/Mean_Cali(2); % 0.8442;
Std_Dec(2) = 0.0428; Std_Fin(2) = 0.0563;

Mean_Dec(3) = 0.6003; Mean_Fin(3) = Mean_Dec(3)/Mean_Cali(3); %0.8396;
Std_Dec(3) = 0.0373; Std_Fin(3) = 0.0522;

Mean_Dec(4) = 0.5039; Mean_Fin(4) = Mean_Dec(4)/Mean_Cali(4); %0.7849;
Std_Dec(4) = 0.0287; Std_Fin(4) = 0.0447;

Mean_Dec(5) = 0.4630; Mean_Fin(5) = Mean_Dec(5)/Mean_Cali(5); %0.7456;
Std_Dec(5) = 0.0275; Std_Fin(5) = 0.0443;

Mean_Dec(6) = 0.4455; Mean_Fin(6) = Mean_Dec(6)/Mean_Cali(6); %0.7603;
Std_Dec(6) = 0.0226; Std_Fin(6) = 0.0386;

Mean_Dec(7) = 0.4233; Mean_Fin(7) = Mean_Dec(7)/Mean_Cali(7); %0.7725;
Std_Dec(7) = 0.0247; Std_Fin(7) = 0.0450;

Fin = Mean_Fin./Dec;
Fin_Std = Std_Dec./Mean_Cali;
