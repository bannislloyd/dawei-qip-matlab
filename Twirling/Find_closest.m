...
function [C D] = Find_closest(A,B,n)

% Check the notation of A (e.g. '+1XX...X' vs 'XX...X')
coeff = [];
flag = 0;
...
Xn = strrep(Xn,'0','X'); % Replace 0 with X

% Keep only those that have identities at the correct positions
posI = (A{1} == In); % position of the identities
