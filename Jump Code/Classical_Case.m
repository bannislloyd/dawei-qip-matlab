...
hold on
plot(r_para,0.5+0.5*sqrt(1-r_para),'k')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
rho_sys11 = kron(hada,hada)*rho_sys11*kron(hada,hada)';
Fidelity11 = Fidelity11 + 0.5*abs(trace(System*rho_sys11)); %/sqrt(trace(System*System)*trace(rho_sys*rho_sys));
