...
%   result = Q1*s*Q1'+Q2*s*Q2'; % density matrix of the C1-C6 system
  ...
  %% the largest two 67, 1000010, 0.4655
  %%　　　　　　　　　 68, 1000011, 0.4652
  %% when initial state is s = kron(ones(2^6)/2^(6),Iz)
  %% the largest two 67, 1000010, 0.0769
  %%　　　　　　　　　 68, 1000011, 0.0742
  %% when initial state is s = kron(ones(2^6)/2^(6),Ix)
  %% the largest two 67, 1000010, 0.4591
  %%　　　　　　　　　 68, 1000011, 0.4592