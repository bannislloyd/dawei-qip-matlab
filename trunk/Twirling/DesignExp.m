% Program that designs certification experiments. In this case, n=4
%
% INPUTS:
% n: Number of qubits

%% TO CHANGE THE UNITARY YOU NEED TO MODIFY LINE 68
%%

function data2 = DesignExp(n)
...
%% Create state 2
clear P
%U = eye(2^n); % Unitary to apply
U = kron([0,1;1,0],[0,-i;i,0]); % YOU HAVE TO CHANGE THIS LINE IF YOU WANT ANOTHER UNITARY
for j = 1:4^n-1
    A = data(j,4);
    B = apply_clifford(A,U,n);
    data(j,5) = B;
end
