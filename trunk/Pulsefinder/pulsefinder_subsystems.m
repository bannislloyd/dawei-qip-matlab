...
for ct = 1:1:nbsub
    ...
    %The spins we are taking out ## by DL: setxor is taking out the non
    %overlaped elements in A and B
...
%         sigleU=expm(i*a*I)*expm(-i*b*Iz)*expm(-i*c*Iy)*expm(-i*d*Iz)2013/9/17Hang
