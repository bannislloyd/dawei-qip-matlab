...
%params.stepsize = 1.75e-2;

%Desired unitary
%load U_encoding.mat
%load U_decoding.mat
params.Uwant = expm(-1i*(90*pi/180)/2*full(mkstate('+1XIIIIIIIIIII',0))); 
%load U_grape.mat
%load U_total.mat
%params.Uwant = U_total;
...
params.rfmax = 2*pi*[25e3 25e3 12.5e3 12.5e3];
