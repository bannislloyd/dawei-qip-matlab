...
outputfile = 'twqubit_encoding1_C_nobuffer';
...
outputfile = 'twqubit_encoding1_H_nobuffer';
shpfile = fopen(outputfile,'w');
    fprintf(shpfile,'##TITLE= %s\n',outputfile);
    fprintf(shpfile,'##JCAMP-DX= 5.00 Bruker JCAMP library\n');
    fprintf(shpfile,'##DATA TYPE= Shape Data\n');
...
outputfile = 'twqubit_encoding2_C_nobuffer';
shpfile = fopen(outputfile,'w');
    fprintf(shpfile,'##TITLE= %s\n',outputfile);
    fprintf(shpfile,'##JCAMP-DX= 5.00 Bruker JCAMP library\n');
    fprintf(shpfile,'##DATA TYPE= Shape Data\n');
...
outputfile = 'twqubit_encoding2_H_nobuffer';
shpfile = fopen(outputfile,'w');
    fprintf(shpfile,'##TITLE= %s\n',outputfile);
    fprintf(shpfile,'##JCAMP-DX= 5.00 Bruker JCAMP library\n');
    fprintf(shpfile,'##DATA TYPE= Shape Data\n');
...
load Para.mat
 ...
 outputfile = 'twqubit_encoding3_C_nobuffer';
 shpfile = fopen(outputfile,'w');
     fprintf(shpfile,'##TITLE= %s\n',outputfile);
     fprintf(shpfile,'##JCAMP-DX= 5.00 Bruker JCAMP library\n');
     fprintf(shpfile,'##DATA TYPE= Shape Data\n');
 ...
 outputfile = 'twqubit_encoding3_H_nobuffer';
 shpfile = fopen(outputfile,'w');
     fprintf(shpfile,'##TITLE= %s\n',outputfile);
     fprintf(shpfile,'##JCAMP-DX= 5.00 Bruker JCAMP library\n');
     fprintf(shpfile,'##DATA TYPE= Shape Data\n');
